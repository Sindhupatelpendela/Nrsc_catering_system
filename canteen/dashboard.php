...
";
$active_orders = $pdo->query($sql)->fetchAll(PDO::FETCH_ASSOC);
...
<div class="dashboard-container">
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="dashboard.php" class="active"><i class="fas fa-fire-burner"></i> Live Orders</a></li>
            <li><a href="#"><i class="fas fa-list-check"></i> History</a></li>
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach($active_orders as $order): 
                             $status_class = $order['status'] == 'approved' ? 'status-approved' : 'status-in_progress';
                             $display_status = $order['status'] == 'in_progress' ? 'COOKING' : 'NEW ORDER';
                        ?>
                        <tr>
                            <td>
